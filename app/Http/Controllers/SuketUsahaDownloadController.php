...
class SuketUsahaDownloadController extends Controller
{ 
    public function download(SuketUsaha $record)
    {
        ...
        $customer = new Buyer([
            ...
            'pemohon_hub_di_kel' => $record->pemohon_hub_di_kel,
            'pemohon_nama_kep_kel' => $record->pemohon_nama_kep_kel,
            'usaha_nama' => $record->usaha_nama,
            'usaha_alamat' => $record->usaha_alamat,
